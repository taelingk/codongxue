...
def main():
    ...
    gender_scaler = None
    weight_train_std, weight_val_std, weight_test_std, weight_scaler = standardize_features(weight_train, weight_val,
                                                                                            weight_test)
    height_train_std, height_val_std, height_test_std, height_scaler = standardize_features(height_train, height_val,
                                                                                            height_test)
    ...
    sbp_train_std, sbp_val_std, sbp_test_std, sbp_scaler = standardize_features(sbp_train, sbp_val,
                                                                                sbp_test)  # 新增SBP标准化
    dbp_train_std, dbp_val_std, dbp_test_std, dbp_scaler = standardize_features(dbp_train, dbp_val,
                                                                                dbp_test)  # 新增DBP标准化
