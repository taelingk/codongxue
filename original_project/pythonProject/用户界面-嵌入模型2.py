...
class PulseWaveMonitor(QMainWindow):
    ...
    def init_model_paths(self):
        ...
        self.model_config = {
            'model_path': os.path.join(model_root_dir, 'parallel_resnet_se_lstm_model.onnx'),  # ONNX模型文件
    ...
    def update_one_second_prediction(self):
        ...
        try:
            ...
            # 检查是否需要更新5秒均值
            current_second = int(self.current_window_start)
    ...
    def calculate_five_second_average(self):
        ...
        self.model_status.setStyleSheet("color: green;")
        self.update_status_label.setText(f"更新状态: 5秒均值已更新（基于最近5个1秒推理值）")
